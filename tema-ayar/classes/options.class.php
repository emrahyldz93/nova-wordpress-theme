...
if( ! class_exists( 'CSF_Options' ) ) {
  class CSF_Options extends CSF_Abstract {
    ...
    public $args         = array(
      ...
      // framework title
      'framework_title'         => 'Nova Tema <small>Tema Ayarları</small>',
      'framework_class'         => '',
    ...
    public function set_options() {
      ...
      if( wp_verify_nonce( csf_get_var( 'csf_options_nonce'. $this->unique ), 'csf_options_nonce' ) ) {
        ...
        if( empty( $this->notice ) ) {
          $this->notice = esc_html__( 'Ayarlar Kaydedildi.', 'csf' );
        }
    ...
    public function add_admin_footer_text() {
      $default = 'Bizi Tercih Ettiğiniz İçin Teşekkür Ederiz <a href="https://emrahyldz.com/" target="_blank">Geliştirici</a>';
      ...
      echo '<div class="csf csf-options'. $theme . $class . $wrapper_class .'" data-slug="'. $this->args['menu_slug'] .'" data-unique="'. $this->unique .'">';
        ...
        echo '<div class="csf-header-inner">';
          ...
          echo '<div class="csf-header-right">';
            ...
            echo ( $this->args['show_search'] ) ? '<div class="csf-search"><input type="text" name="csf-search" placeholder="'. esc_html__( 'Arama Yapın..', 'csf' ) .'" autocomplete="off" /></div>' : '';

            echo '<div class="csf-buttons">';
            echo '<input type="submit" name="'. $this->unique .'[_nonce][save]" class="button button-primary csf-save'. $ajax_class .'" value="'. esc_html__( 'Kaydet', 'csf' ) .'" data-save="'. esc_html__( 'Bekleyiniz...', 'csf' ) .'">';
            echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="csf_transient[reset_section]" class="button button-secondary csf-reset-section csf-confirm" value="'. esc_html__( 'Sayfa Ayarı Sıfırla', 'csf' ) .'" data-confirm="'. esc_html__( 'Bu Sayfanın Ayarları Sıfırlanacak Emin misiniz?', 'csf' ) .'">' : '';
            echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="csf_transient[reset]" class="button csf-warning-primary csf-reset-all csf-confirm" value="'. esc_html__( 'Ayarları Sıfırla', 'csf' ) .'" data-confirm="'. esc_html__( 'Ayarları Sıfırlanacak, Emin misiniz?', 'csf' ) .'">' : '';
            echo '</div>';
        ...
        if( ! empty( $this->args['show_footer'] ) ) {
          ...
          echo '<div class="csf-buttons">';
          echo '<input type="submit" name="csf_transient[save]" class="button button-primary csf-save'. $ajax_class .'" value="'. esc_html__( 'Kaydet', 'csf' ) .'" data-save="'. esc_html__( 'Bekleyiniz...', 'csf' ) .'">';
          echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="csf_transient[reset_section]" class="button button-secondary csf-reset-section csf-confirm" value="'. esc_html__( 'Sayfa Ayarı Sıfırla', 'csf' ) .'" data-confirm="'. esc_html__( 'Bu Sayfanın Ayarları Sıfırlanacak Emin misiniz?', 'csf' ) .'">' : '';
          echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="csf_transient[reset]" class="button csf-warning-primary csf-reset-all csf-confirm" value="'. esc_html__( 'Ayarları Sıfırla', 'csf' ) .'" data-confirm="'. esc_html__( 'Ayarlar Sıfırlanacak Emin misiniz?', 'csf' ) .'">' : '';
          echo '</div>';
